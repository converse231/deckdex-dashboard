...
function CardComponent({ card }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex absolute flex-col items-center justify-between gap-8 h-full py-6 right-2 transition-all duration-300 opacity-0 translate-x-10 group-hover:translate-x-0 group-hover:opacity-100">
